...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/ndmservice/ndmservice/main/tools/password"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/ndmservice/ndmservice/main/tools/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/ndmservice/ndmservice/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/ndmservice/ndmservice/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/ndmservice/ndmservice/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/ndmservice/ndmservice/main/issue.net"
